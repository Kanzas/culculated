...
class CCBConditionsHelper {
	...
	public static $conditionStates = array(
		array(
			'title'  => 'Is selected',
			'value'  => '==',
			'fields' => array( 'dropDown', 'radio', 'dropDown_with_img', 'radio_with_img' ),
		),
		array(
	...
	public static $actions = array(
		array(
			...
			'value'     => 'show',
			'flex_grow' => '0',
			'fields'    => array( 'checkbox', 'datePicker', 'timePicker', 'dropDown', 'dropDown_with_img', 'checkbox_with_img', 'radio_with_img', 'html', 'line', 'multi_range', 'quantity', 'radio', 'range', 'range_datePicker', 'text', 'toggle', 'total', 'file_upload', 'file_upload_with_price' ),
		),
		array(
			'title'     => 'Hide',
			'value'     => 'hide',
		...
		array(
			...
			'flex_grow' => '0',
			'fields'    => array( 'checkbox', 'datePicker', 'timePicker', 'dropDown', 'dropDown_with_img', 'checkbox_with_img', 'radio_with_img', 'multi_range', 'quantity', 'radio', 'range', 'range_datePicker', 'toggle' ),
		),
		array(
			'title'     => 'Disable',
			'value'     => 'disable',
